...
x_player = random.randint(1, 9)
y_player = random.randint(1, 9)
...
number_of_moves = 0
distance_before_move = sqrt((x_key - player_position[0]) **2 + (y_key - player_position[1])**2)
...
while player_position != key_position:
    ...
    distance_after_move = sqrt((x_key - player_position[0]) **2 + (y_key - player_position[1]) **2)
